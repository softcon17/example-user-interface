...
gulp.task('build', function(callback) {
  gulpSequence('clean', 'sass', 'transpile', 'polymer:cli')(callback);
});

gulp.task('polymer:cli', function (callback) {
  console.log("Please be patient. Polymer build can take a few mins");
